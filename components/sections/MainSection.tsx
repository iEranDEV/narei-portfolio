...
export default function MainSection() {
    ...
    return (
        <div className="w-full grid md:grid-cols-2 relative h-screen px-5">
            ...
            {/* Right section - photo */}
            <div className="hidden md:flex w-full bg-slate-50 h-full justify-center items-center">
                
            </div>

            {/* Jumping arrow */}
            <motion.div initial={{x: '-50%', y: 280}} animate={{y: [280, 270, 280]}} transition={{repeat: Infinity}} className="absolute left-1/2 top-1/2 ">
                <AiOutlineArrowDown className="h-8 w-8" />
            </motion.div>

            {/* Wave */}
            <svg width="100%" id="svg" viewBox="0 0 1440 390" xmlns="http://www.w3.org/2000/svg" className="absolute bottom-0 xl:-bottom-20 -left-0 transition duration-300 ease-in-out delay-150">
